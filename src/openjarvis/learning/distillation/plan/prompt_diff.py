...
def maybe_downgrade_to_replace(
    ...
    *,
    ...
    -------
    Edit
        The edit unchanged if it is not a PATCH op, or if the diff is small
        enough. Returns a new REPLACE edit if the diff changes more than 50%
        of lines or if the diff cannot be applied.
    """
